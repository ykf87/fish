...
EOT;
    ...
    {
        Admin::baseJs(['https://cdnjs.cloudflare.com/ajax/libs/spark-md5/3.0.0/spark-md5.js', 'https://cdn.bootcss.com/axios/0.18.0/axios.min.js', 'http://code.jquery.com/jquery-migrate-1.2.1.min.js']);
